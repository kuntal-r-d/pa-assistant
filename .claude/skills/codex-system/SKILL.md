...
**Subagent pattern recommended.** To preserve main orchestrator context.

| Situation | Method |
|-----------|--------|
| Detailed design consultation | Via subagent (recommended) |
| Debug analysis | Via subagent (recommended) |
| Short questions (1-2 sentence answer) | Direct call OK |
...
| **Debugging** | "Why doesn't it work?" "Error" |
